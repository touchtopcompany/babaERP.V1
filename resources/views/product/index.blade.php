                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="product_list_tab">
                        @if($is_admin)
                            ...
                            <button type="button" class="btn btn-primary btn-modal pull-right mr-2 margin-left-10"
                                data-href="{{action([\App\Http\Controllers\ReportController::class, 'getStockEvaluationByDepartmentReport'])}}"
                                data-container=".view_modal" data-bcup-haslogintext="no">
                            <i class="fa fa-plus"></i> @lang('messages.print_report')</button>
                        @endif
                        @can('product.create')                            
...
@section('javascript')
    ...
    <script type="text/javascript">
        $(document).ready( function(){
            product_table = $('#product_table').DataTable({
                ...
                "ajax": {
                    ...
                    "data": function ( d ) {
                        ...
                        d.stock_status_id = $('#stock_status_id').val();
                ...
                columns: [
                        ...
                        @can('view_purchase_price')
                            {data: 'min_unit_price', name: 'min_unit_price', searchable: false,},
            ...
            $(document).on('change', '#stock_status_id, #product_list_filter_type, #product_list_filter_category_id, #product_list_filter_brand_id, #product_list_filter_unit_id, #product_list_filter_tax_id, #location_id, #active_state, #repair_model_id',
                function() {

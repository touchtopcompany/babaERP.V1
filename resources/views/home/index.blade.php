...
{{--                            <i class="ion ion-ios-cart-outline"></i>--}}
                            <img src="{{asset('img/shopping.png')}}" width="42px">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style">
                       <span class="info-box-icon bg-green">
                               <img src="{{asset('img/due-diligence.png')}}" width="42px">
...
{{--                            <i class="ion ion-ios-paper-outline"></i>--}}
                                                                                     <img src="{{asset('img/due-date.png')}}" width="42px">
{{--                            <i class="fa fa-exclamation"></i>--}}
                       </span>

                        <div class="info-box-content">
                          <span class="info-box-text">{{ __('home.invoice_due') }}</span>
                          <span class="info-box-number invoice_due">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style">
                       <span class="info-box-icon bg-teal text-white">
                              <img src="{{asset('img/return.png')}}" width="42px">
{{--                            <i class="fas fa-exchange-alt"></i>--}}
                       </span>

                        <div class="info-box-content">
                          <span class="info-box-text">{{ __('Total Due Sell Return') }}</span>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style">
                        <span class="info-box-icon bg-aqua">
                              ...
                              <img src="{{asset('img/purchase.png')}}" width="42px">
{{--                            <i class="ion ion-cash"></i>--}}
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                   <div class="info-box info-box-new-style">
                        <span class="info-box-icon bg-yellow">
                                                                                     <img src="{{asset('img/seo.png')}}" width="42px">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12 col-custom">
                    <div class="info-box info-box-new-style">
                       <span class="info-box-icon bg-red text-white">
                                                         <img src="{{asset('img/product-return.png')}}" width="42px">
...
{{--                          <i class="fas fa-minus-circle"></i>--}}
                                                                                                                 <img src="{{asset('img/expense.png')}}" width="42px">
                        </span>
...
@stop
@section('javascript')
    <script src="{{ asset('js/home.js?v=' . 12) }}"></script>
    ...
    <script type="text/javascript">
        ...
        $('#pending_shipments_location').change( function(){
         ...
         //Check sms quantity
        //  if($_SERVER['SERVER_NAME'] === 'touchtop.babaerp.live'){
            $(document).ready(function() {
                var loader = '<i class="fas fa-sync fa-spin fa-fw margin-bottom"></i>';
                let container = $('#smsCount');
                if(container.length) {
                    $('.notified').css('margin-top', '1rem')
                    ...
                    function getBalance() {
                        $.ajax({
                            ...
                            success: function (response) {
                                if (response.data) {
                                    container.html(response.data.credit_balance)
                                    container.addClass('badge rounded-pill badge-notification bg-danger')
                                }

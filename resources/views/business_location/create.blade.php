        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-sm-6">
                 ...
                 @if(!empty($common_settings['enable_multi_currency']) && $exch_count > 0)
                    <div class="col-sm-4 mt-15" style="margin-left: 1.5rem">
                        <div class="form-group">
                            <div class="checkbox">
                                {{ Form::checkbox('common_settings[multi_currency_enabled]', 1, !empty($location->common_settings['multi_currency_enabled']) , [ 'class' => 'input-icheck', 'id' => 'enable_multi_currency']) }} {{ __( 'lang_v1.enable_location_multi_currency' ) }}
                            </div>
                        </div>
                    </div>
                @endif

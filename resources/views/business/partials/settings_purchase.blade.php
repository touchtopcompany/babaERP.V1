    ...
    <div class="col-sm-6">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('common_settings[enable_confirm_order]', 1, !empty($common_settings['enable_confirm_order']) , [ 'class' => 'input-icheck', 'id' => 'enable_confirm_order']); !!} {{ __( 'lang_v1.enable_order_confirmation' ) }}
                    </label>
                    @show_tooltip(__('lang_v1.order_confirmation_help_text'))
                </div>
            </div>
        </div>

    ...
    <div class="row">
        ...
        <div class="col-sm-4">
         ...
         <div class="col-sm-4 mt-15">
            <div class="form-group">
                <div class="checkbox">
                    {!! Form::checkbox('common_settings[enable_multi_currency]', 1, !empty($common_settings['enable_multi_currency']) , [ 'class' => 'input-icheck', 'id' => 'enable_multi_currency']); !!} {{ __( 'lang_v1.enable_multi_currency' ) }}
                </div>
            </div>
        </div>
        <div class="clearfix"></div>

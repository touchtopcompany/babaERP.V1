...
<![endif]-->
<!--<script src="{{ asset('js/vendor_bitl_removed.js?v=' . $asset_v) }}"></script>-->
<!--<script src="{{ asset('js/vendor_with_mobile.js') }}"></script>-->
<script src="{{ asset('js/vendor2.js') }}"></script>
...
@php
    ...
    //Pricing strategy
    $pricing_strategy = session('business.pricing_profit_strategy') ?? null;
@endphp
...
<script>
    ...
    var __default_datatable_page_entries = "{{$default_datatable_page_entries}}";
        ...
        let __pricing_strategy = "{{ $pricing_strategy }}";
...
<script src="{{ asset('js/functions.js?v=152453') }}"></script>
<script src="{{ asset('js/common.js?v=1' . $asset_v) }}"></script>

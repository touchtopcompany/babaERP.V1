...
<head>
    ...
    <style>
        .right-col {
            background-image: url("{{ asset('img/background-aut.png') }}") !important;
        ...
        .left-col {
            background: linear-gradient(0deg,rgba(0, 0, 0, 0.76),rgba(51, 51, 51, 0.32)),url(../img/LEFTIMAGE.png) !important;
            ...
            <div class="col-md-5 col-sm-5 hidden-xs left-col eq-height-col" >
                <div class="left-col-content login-header"> 
                    ...
                    @if(!empty(config('constants.app_title')))
                        <small class='text-white'>{{config('constants.app_title')}}</small>
                    @endif
                    </div>
                </div>
            </div>

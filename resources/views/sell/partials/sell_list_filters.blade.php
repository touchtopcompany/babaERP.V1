...
<div class="col-md-3">
    <div class="form-group">
        ...
        {!! Form::select('sell_list_filter_payment_status', [\App\Enums\SellPaymentStatus::PAID => __('lang_v1.paid'), \App\Enums\SellPaymentStatus::DUE => __('lang_v1.due'), \App\Enums\SellPaymentStatus::PARTIAL => __('lang_v1.partial'), \App\Enums\SellPaymentStatus::OVERDUE => __('lang_v1.overdue'), \App\Enums\SellPaymentStatus::OUTSTANDING => __('lang_v1.outstanding_balance')], null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]); !!}
    </div>
</div>
@endif

        ...
        <div class="col-md-8">
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('permissions[]', 'edit_product_price_from_purchase_screen', in_array('edit_product_price_from_purchase_screen', $role_permissions), ['class' => 'input-icheck']); !!}
                        {{ __('lang_v1.edit_product_price_from_purchase_screen') }}
                    </label>
                </div>
            </div>
          <div class="col-md-12">
            ...
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'product.stock_taking', in_array('product.stock_taking', $role_permissions),['class' => 'input-icheck']); !!}
                {{ __('lang_v1.stock_taking') }}
              </label>
              @show_tooltip(__('lang_v1.product_stock_taking_tooltip'))
            </div>
          </div>
        </div>
        </div>
            ...
            <div class="row check_group">
                ...
                <div class="col-md-8">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::radio('radio_option[stock_adjustment_view]', 'view_own_stock', in_array('view_own_stock', $role_permissions),['class' => 'input-icheck']); !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'stock_adjustment.edit', in_array('stock_adjustment.edit', $role_permissions),
                                [ 'class' => 'input-icheck']); !!} {{ __( 'role.stock_adjustment.edit' ) }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
            ...
            <div class="row check_group">
                ...
                <div class="col-md-8">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                ...
                                [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.view_all_stock_transfers' ) }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::radio('radio_option[stock_transfer_view]', 'view_own_stock_transfer', in_array('view_own_stock_transfer', $role_permissions),['class' => 'input-icheck']); !!}
                                {{ __('lang_v1.view_own_stock_transfer') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'stock_transfer.edit', in_array('stock_transfer.edit', $role_permissions),
                                [ 'class' => 'input-icheck']); !!} {{ __( 'role.stock_transfer.edit' ) }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
            ...
            <div class="col-md-8">
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="checkbox">
                        <label>
                            {!! Form::checkbox('permissions[]', 'purchase_order.confirm', in_array('purchase_order.confirm', $role_permissions),
                            [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.confirm_purchase_order' ) }}
                        </label>
                    </div>
                </div>
              <div class="col-md-12">
            ...
            <div class="col-md-12">
              <div class="checkbox">
               ...
               <div class="col-md-12">
                  <div class="checkbox">
                      <label>
                          {!! Form::checkbox('permissions[]', 'so.confirm', in_array('so.confirm', $role_permissions),
                 [ 'class' => 'input-icheck']); !!} {{ __( 'lang_v1.confirm_so' ) }}
                      </label>
                  </div>
              </div>
            <div class="col-md-12">
      ...
      <hr>
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('spg_permissions[]', 'price_group.' . $selling_price_group->id, in_array('price_group.' . $selling_price_group->id, $role_permissions),
         ...
         @if(multiCurrencyEnabled())
            ...
            <div class="row">
                <div class="col-md-3">
                    <h4>@lang( 'Multi Currency' )</h4>
                </div>
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'access_multi_currency_settings', in_array('access_multi_currency_settings', $role_permissions),
                                [ 'class' => 'input-icheck']); !!} {{ __('lang_v1.access_multi_currency_settings') }}
                            </label>
                        </div>
                    </div>
                </div>

        ...
        <div class="col-md-8">
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('permissions[]', 'edit_product_price_from_purchase_screen',false, ['class' => 'input-icheck']); !!}
            ...
            <div class="col-md-12">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('permissions[]', 'product.stock_taking', false,['class' => 'input-icheck']); !!}
            ...
            <div class="row check_group">
                ...
                <div class="col-md-8">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::radio('radio_option[stock_adjustment_view]', 'view_own_stock', false,['class' => 'input-icheck']); !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'stock_adjustment.edit', false,
            ...
            <div class="row check_group">
                ...
                <div class="col-md-8">
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::radio('radio_option[stock_transfer_view]', 'view_own_stock_transfer',false,['class' => 'input-icheck']); !!}
                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'stock_transfer.edit', false,
            ...
            <div class="col-md-8">
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="checkbox">
                        <label>
                            {!! Form::checkbox('permissions[]', 'purchase_order.confirm', false,
          ...
          <div class="col-md-8">
            ...
            <div class="col-md-12">
             ...
             <div class="col-md-12">
                  <div class="checkbox">
                      <label>
                          {!! Form::checkbox('permissions[]', 'so.confirm', false,
      ...
      <div class="col-md-8">
        ...
        <div class="col-md-9">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('spg_permissions[]', 'price_group.' . $selling_price_group->id, false,
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'access_multi_currency_settings', false,

...
//        return $modules;
    ...
    {
        if ($this->isSuperadminInstalled() && auth()->user()->can('superadmin')) {
            ...
            //Check if the module is activated for this business
            $explode_permission = explode('_', $permission);
            $module = $explode_permission[0];
            if($this->isModuleEnabled($module, $business_id)){
                return true;
            }
            return false;
        }
    ...
    {
        return [
                        'products' => ['name' => __('business.product')],
            ...
            'stock_taking' => ['name' => __('lang_v1.stock_taking')]
        ];
    }

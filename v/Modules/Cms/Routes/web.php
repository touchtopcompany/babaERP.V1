...
|
*/
Route::get('c/', [Modules\Cms\Http\Controllers\CmsController::class, 'index']);
...
Route::middleware('web', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu')->prefix('cms')->group(function () {

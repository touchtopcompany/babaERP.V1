...
class BaseController extends Controller
{
    ...
    public function respondWithError(mixed $message, bool $json_response)
    {
        if ($json_response) {
    ...
    public function respondWentWrong(object $exception = null)
    {
        ...
        return $this->setStatusCode(500)->respondWithError($message, true);
    }
    public function respondSuccess( mixed $message, bool $json_response, $additional_data = [])
    {
        ...
        return $json_response ? $this->setStatusCode(200)->respond($data) : $data;
    }

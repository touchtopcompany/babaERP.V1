...
return [
    ...
    */
    ...
    'shipping' => 'Set shipping details and shipping charges. Click on the edit icon below to add/update shipping details and charges.',
        'pricing_profit_strategy' => "<small class='text-muted'>Used to calculate either profit margin or markup based on selling price and purchase price entered.<br/> You can modify this value for individual products while adding</small>",

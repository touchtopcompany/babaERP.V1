<tr class="product_row">
    ...
    <td>
        @php
            ...
            $qty_ordered = $product->quantity_ordered;
             ...
             if(!empty($product->group_purchasing_price)){
                $product->last_purchased_price = $product->group_purchasing_price;
            }
        @endphp
    ...
    <td>
        ...
        <br>
        <small class="text-muted text-danger text-bold" style="white-space: nowrap;">@lang('report.transfer_current_stock'): <span class="qty_available_text">{{$product->transfer_qyt_available}}</span> {{ $product->unit }}</small>
    </td>

...
{{--							{{$receipt_details->display_name}}--}}
                ...
                @if(!empty($receipt_details->address))
                    {!! __('LOCATION : KIJUJU HOUSE, NEAR VALENTINO HOTEL AGGREY NA LIKOMA, KARIAKOO') !!}
                ...
                @if(!empty($receipt_details->contact))
                    ...
                    {!! __('MOBILE : 0763009060/ 0748375750/ 0694335600') !!}
                @endif
    ...
    <div class="textbox-info">
        ...
        <p class="f-right">
            {{Carbon::createFromTimestamp(strtotime($receipt_details->invoice_date))->format('d M Y H:i:s')}}
        </p>
    </div>
    ...
    <!-- customer info -->
    <br/>
     <div class="textbox-info headings" >
                        ...
                        <p class="text-left m-0 mt-5 pull-left">{{$line['name']}}
                            ...
                            @if($receipt_details->show_base_unit_details && $line['quantity'] && $line['base_unit_multiplier'] !== 1)
                                <br><small>
                                    ...
                                    <br> {{$line['quantity']}} x {{$line['base_unit_multiplier']}}
                                    = {{$line['orig_quantity']}} {{$line['base_unit_name']}} <br>
    ...
    <br/>
    <br/>
    <p class="sub-headings">KUMBUKA</p>
    <ol>
        <li>Marejesho yoyote lazima yafanywe ndani ya siku 30 za kazi kuanzia tarehe ya ununuzi</li>
        <li>Hakuna Dhamana ikiwa kibandiko cha TOP au BOTTOM kimeondolewa au kuharibiwa</li>
        <li>Hakuna Malalamiko au Kurudisha bidhaa bila risiti</li>
        <li>Hakuna kurejeshewa pesa taslimu</li>
    </ol>
    <br/>
    <p class="sub-headings">NJIA YA MALIPO</p>
    <ol>
        <li>CRBD BANK - 0152207606200</li>
        <li>NMB BANK - 33410018119</li>
        {{--           <li>NBM BANK - 33410018119</li>--}}
        <li>LIPA KWA VODA - 5489205 <br> <b>JINA LA AKAUNTI : BARAKA WALES NDABAHA</b></li>
        <li>LIPA KWA TIGO - 8726354 <br> <b>JINA LA AKAUNTI : OBAMA MOBILE TECHNOLOGY</b></li>

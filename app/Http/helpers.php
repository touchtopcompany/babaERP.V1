...
if(!function_exists('multiCurrencyEnabled')){
    function multiCurrencyEnabled(): bool
    {
        return ! empty(session('business.common_settings')) && !empty(session('business.common_settings')['enable_multi_currency']);
    }
}

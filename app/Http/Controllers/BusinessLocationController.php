...
class BusinessLocationController extends Controller
{
     ...
     * @return void
     */
    public function __construct(ModuleUtil $moduleUtil, Util $commonUtil, protected MultiCurrencyUtil $multiCurrencyUtil,protected BusinessUtil $businessUtil)
    {
 ...
 //   dd($exch_count);
        ...
        // $currencies = $this->multiCurrencyUtil->pluckCurrencies(null, true);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $input['common_settings'] = ! empty($request->input('common_settings')) ? $request->input('common_settings') : null;

...
//        dd(serialize([
//           'n' => 'VFD (Virtual Fiscal Device)',
//            'dn' => 'VFD (Virtual Fiscal Device) Module',
//            'u' => 'https://www.touchtop.co.tz/babaerp/module/buy_vfd',
//            'd' => 'Virtual Fiscal Device (VFD), cash register substitute for Electronic Fiscal Device (EFD).'
//        ]));
        ...
        public function __available_modules()
    {
        ...
        $modules = [
           [
            ...
            [
               "n" => "HMS",
               "dn" => "Hotel Management System Module",
            ...
            [
               ...
               "d" => "Allows you to create spreadsheet and share with employees, roles & todos."
           ],
     ...
     public function __purchased_modules()
    {
        return [
            'essentials',
            'cms',

        ...
        try {
            ...
            if ($request->hasFile('inventory_csv')) {
                ...
                foreach ($imported_data as $key => $value) {
                    ...
                    if (!$product_details) {
                        throw new \Exception("Product {$pro_name} not found on row no. $row_no");
                    }
...
//                    //Generate reference number
                    ...
                    // $product_get = Product::query()->where([
                    //     'product_id' => $product_id,
                    //     'location_id' => $location_id
                    // ])->first();
                    ...
                    $this->productUtil->activityLog($product_details, 'update_stock', null, $log);

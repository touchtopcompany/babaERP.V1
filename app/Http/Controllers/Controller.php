...
class Controller extends BaseController
{
  ...
  public function respondWithError($message = null, $res_json = true)
    {
        return $res_json
     ...
     * @return \Illuminate\Http\Response
     */
    public function respondWentWrong(object $exception = null, $is_json = true)
    {
        ...
        return $this->setStatusCode(200)
            ->respondWithError($message, $is_json);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function respondSuccess($message = null, $res_json= true, $additional_data = [])
    {
        $message = is_null($message) ? __('lang_v1.success') : $message;
        ...
        return $res_json ? $this->respond($data) : $data;
    }

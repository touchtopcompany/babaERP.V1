...
class AccountingController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $location = request()->get('location_id', null);
        ...
        $coa_overview = AccountingAccount::leftjoin('accounting_accounts_transactions as AAT',
                                ...
                                ->when(!empty($location), function ($query) use($location) {
                                    $query->rightJoin('transactions as T', 'T.id', '=', 'AAT.transaction_id')
                                        ->where('T.location_id', $location);
                                })
        ...
        return view('accounting::accounting.dashboard')->with(compact('coa_overview_chart',
                'all_charts', 'coa_overview', 'account_types', 'end_date', 'start_date', 'business_locations'));
    }
